...
Page(Object.assign({}, swiperAutoHeight, navCart, {
  ...
  searchImg() {
    util.navigateTo({
      url: './productList/productList?keyWord=' + this.data.searchWord + '&page=index'
    })
  },
  // 搜索商品
  searchProduct: function (e) {
    util.navigateTo({
      url: './productList/productList?tenantId=' + this.data.tenantId + '&keyWord=' + e.detail.value + '&page=index'
    })
  },
  toList() {
    util.navigateTo({
      url: './productList/productList?tenantId=' + this.data.tenantId + '&keyWord=&page=index'
    })
  },
  adTap(e) {
